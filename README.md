...
3. Jalankan test:
   ...
   python login_positive_test.py
   python login_negative_test.py
   python product_test.py
   python register_positive_test.py
   python register_email_exist_test.py
   ```
